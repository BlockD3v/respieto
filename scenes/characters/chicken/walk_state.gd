...
func _on_physics_process(_delta : float) -> void:
	...
	if navigation_agent_2d.avoidance_enabled:
		...
		# move_and_slide() will be called in the callback
	else:
		character.velocity = velocity   # indented under else
		character.move_and_slide()     # indented under else
